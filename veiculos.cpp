...
Veiculos::Veiculos(string n_modelo, int n_ano , float n_valor_base, string n_cor, string n_filial):
    modelo(n_modelo), cor(n_cor), valor_base(n_valor_base), ano(n_ano), filial(n_filial) {};
...
Moto::Moto(string n_modelo, int n_ano , float n_valor_base, string n_cor, string n_filial):
    Veiculos(n_modelo, n_ano, n_valor_base, n_cor, n_filial){};
    
// CORREÇÃO: Retornar "Moto" para compatibilidade com CSV
string Moto::motoOuCarro() {return "Moto";}

Carro::Carro(string n_modelo, int n_ano , float n_valor_base, string n_cor,string n_filial):
    Veiculos(n_modelo, n_ano, n_valor_base, n_cor, n_filial){};
