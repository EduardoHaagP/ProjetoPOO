#include "veiculos.h"
    ...
    Veiculos::Veiculos(string n_modelo, int n_ano , float n_valor_base, string n_cor): modelo(n_modelo), cor(n_cor), valor_base(n_valor_base), ano(n_ano) {};
    ...
    Moto::Moto(string n_modelo, int n_ano , float n_valor_base, string n_cor): Veiculos(n_modelo, n_ano, n_valor_base, n_cor){};
    string Moto::motoOuCarro() {return "moto";}
    //modelo, ano, valor, cor
    Carro::Carro(string n_modelo, int n_ano , float n_valor_base, string n_cor): Veiculos(n_modelo, n_ano, n_valor_base, n_cor){};
